...
public class BikeParkingService implements ParkingService {
    ...
    private List<VehicleBill> BILL_LIST = new LinkedList<VehicleBill>() {{
        add(VehicleBill.builder().vehicleType(VehicleType.Bike).amount(20).paymentMode(PaymentMode.Upi).build());
        add(VehicleBill.builder().vehicleType(VehicleType.Bike).amount(20).paymentMode(PaymentMode.Cash).build());
        add(VehicleBill.builder().vehicleType(VehicleType.Bike).amount(0).paymentMode(PaymentMode.Cancelled).build());
        add(VehicleBill.builder().vehicleType(VehicleType.Bike).amount(0).paymentMode(PaymentMode.UTurn).build());
    }};
