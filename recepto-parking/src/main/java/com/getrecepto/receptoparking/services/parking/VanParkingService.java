...
@Slf4j
@Service("VanParkingService")
public class VanParkingService implements ParkingService {
    @Autowired
    ...
    private List<VehicleBill> BILL_LIST = new LinkedList<VehicleBill>() {{
        add(VehicleBill.builder().vehicleType(VehicleType.Van).amount(150).paymentMode(PaymentMode.Upi).build());
        add(VehicleBill.builder().vehicleType(VehicleType.Van).amount(150).paymentMode(PaymentMode.Cash).build());
        add(VehicleBill.builder().vehicleType(VehicleType.Van).amount(0).paymentMode(PaymentMode.Cancelled).build());
        add(VehicleBill.builder().vehicleType(VehicleType.Van).amount(0).paymentMode(PaymentMode.UTurn).build());
    }};
